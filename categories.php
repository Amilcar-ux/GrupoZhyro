...
// categories.php
session_start();
// Si quieres protegerlo como admin, descomenta:
                        ...
                        <div class="full-width panel-content">
                            <form>
                                ...
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input class="mdl-textfield__input" type="text" id="NameCategory">
                                    <label class="mdl-textfield__label" for="NameCategory">Name</label>
                                    <span class="mdl-textfield__error">Invalid name</span>
                                </div>
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input class="mdl-textfield__input" type="text" id="descriptionCategory">
